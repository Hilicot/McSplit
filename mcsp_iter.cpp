      ...
      else
      {
        ...
        if (w != -1)
        {
          ...
          if (current_sol.size() > best_sol.size())
          {
            ...
            time_elapsed += (double)(lap.tv_nsec - start.tv_nsec) / 1000000000.0; // adding elapsed nanoseconds
            ...
            {
              cout << "Incumbent size: " << best_sol.size() << " Iterations: " << nodes << " Time: " << time_elapsed << endl;
            }
          }
