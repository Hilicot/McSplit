...
dal: prelim mcsplit+DAL.cpp graph.cpp graph.h mcs.h mcs.cpp stats.h args.h test_utility.cpp reward.cpp reward.h
	$(CXX) $(CXXFLAGS) -Wall -std=c++2a -o build/mcsplit-dal mcsplit+DAL.cpp graph.cpp mcs.h mcs.cpp test_utility.cpp reward.cpp -pthread
