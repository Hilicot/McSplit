...
void solve(const Graph &g0, const Graph &g1, vector<vector<gtype>> &V, vector<vector<vector<gtype>>> &Q, vector<VtxPair> &incumbent,
           ...
           vector<Bidomain> &domains, vector<int> &left, vector<int> &right, unsigned int matching_size_goal, Stats *stats)
{
    ...
    for (int i = 0; i <= bd.right_len; i++)
    {
        ...
        stats->dl++;
        solve(g0, g1, V, Q, incumbent, current, g0_matched, g1_matched, new_domains, left, right, matching_size_goal, stats);
